                        ...
                        if ($laptopResult && $laptopResult->num_rows > 0) {
                            while($laptop = $laptopResult->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <form method='post' action='delete_log.html'>
                                                <input type='hidden' name='assetSerial' value='" . htmlspecialchars($laptop["assetSerial"]) . "'>
                        ...
                        if ($desktopResult && $desktopResult->num_rows > 0) {
                            while($desktop = $desktopResult->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <form method='post' action='delete_log.html'>
                                                <input type='hidden' name='assetSerial' value='" . htmlspecialchars($desktop["assetSerial"]) . "'>
                                                <button type='submit' class='delete-button'>Delete</button>
                                            </form>
                                        </td>
                                      </tr>";
                        ...
                        if ($tabletResult && $tabletResult->num_rows > 0) {
                            while($tablet = $tabletResult->fetch_assoc()) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <form method='post' action='delete_log.html'>
                                                <input type='hidden' name='assetSerial' value='" . htmlspecialchars($tablet["assetSerial"]) . "'>
                                                <button type='submit' class='delete-button'>Delete</button>
                                            </form>
                                        </td>
                                      </tr>";
...
<script>
    $(document).ready(function() {
        ...
        $('.delete-button').on('click', function() {
            ...
            var assetSerial = $row.data('serial');
